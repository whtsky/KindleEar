...
DOMAIN = "http://{}/".format(get_default_version_hostname())  # Your domain of app
...
DEFAULT_COVER = (
    "cv_default.jpg"
)  # default cover, leave it empty will not add cover to book
DEFAULT_COVER_BV = (
    DEFAULT_COVER
...
MANGA_CROP_MARGIN_POWER = 0
MANGA_CROP_PAGE_NUMBER_POWER = 0
